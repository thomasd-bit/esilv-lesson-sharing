...
| Releases publiées | 17 (`v0.1.0`, `v0.4.0`, `v0.4.1`, `v0.5.0`, `v0.5.1`, `v0.5.2`, `v0.5.3`, `v0.5.4`, `v0.5.5`, `v0.5.6`, `v0.5.7`, `v0.5.8`, `v0.5.9`, `v0.5.10`, `v0.5.11`, `v0.5.12`, `v0.5.13`) | dix-sept versions publiques et documentées ; |
...
Le dépôt expose aussi la [PR initiale fusionnée](https://github.com/thomasd-bit/esilv-lesson-sharing/pull/1) et la [release `v0.5.13`](https://github.com/thomasd-bit/esilv-lesson-sharing/releases/tag/v0.5.13). Ces éléments prouvent une activité de maintenance, pas encore une adoption par la promo.
